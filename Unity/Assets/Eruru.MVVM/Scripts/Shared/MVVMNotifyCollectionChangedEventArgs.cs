...
namespace Eruru.MVVM {
	...
	/// </summary>
	//[TypeForwardedFrom ("WindowsBase, Version=3.0.0.0, Culture=Neutral, PublicKeyToken=31bf3856ad364e35")]
	public class MVVMNotifyCollectionChangedEventArgs : EventArgs {
		//------------------------------------------------------
		//
		//  Constructors
		//
		...
		public MVVMNotifyCollectionChangedEventArgs (MVVMNotifyCollectionChangedAction action, object changedItem) {
		...
		public MVVMNotifyCollectionChangedEventArgs (MVVMNotifyCollectionChangedAction action, IList newItems, IList oldItems) {
			if (action != MVVMNotifyCollectionChangedAction.Replace)
				throw new Exception ("action");
			if (newItems == null)
		...
		public MVVMNotifyCollectionChangedEventArgs (MVVMNotifyCollectionChangedAction action, object changedItem, int index, int oldIndex) {
		...
		/// </summary>
		public MVVMNotifyCollectionChangedAction Action {
			get { return _action; }
		}
		...
		private MVVMNotifyCollectionChangedAction _action;
	...
	/// </summary>
	//[TypeForwardedFrom ("WindowsBase, Version=3.0.0.0, Culture=Neutral, PublicKeyToken=31bf3856ad364e35")]
	public delegate void MVVMNotifyCollectionChangedEventHandler (object sender, MVVMNotifyCollectionChangedEventArgs e);
